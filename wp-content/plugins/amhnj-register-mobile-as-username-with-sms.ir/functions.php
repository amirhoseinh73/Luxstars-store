...
add_filter( 'woocommerce_locate_template', 'register_mobile_load_woocommerce_templates_from_plugin', 1, 3 );
function register_mobile_load_woocommerce_templates_from_plugin( $template, $template_name, $template_path ) {
     global $woocommerce;
     $_template = $template;
