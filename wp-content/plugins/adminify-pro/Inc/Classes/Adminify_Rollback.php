...
class Adminify_Rollback
{
    ...
    public function jltwp_adminify_post_addons_rollback()
    {
        ...
        if (empty($_GET['version']) || !in_array($_GET['version'], $rollback_versions)) {
            wp_die(esc_html__('Error occurred, The version selected is invalid. Try selecting different version.', WP_ADMINIFY_TD));
        }
...
<?php
    ...
    protected function upgrade()
    {
        ...
        $upgrader_args = [
            ...
            'title' => '<img src="' . $logo_url . '" alt="WP Adminify Version Rollback">' . __('Rollback to Previous Version ', WP_ADMINIFY_TD),
        ];
