...
class QuickCircleMenu extends AdminSettingsModel
{
    public function __construct()
    {
        if (is_admin()) {
            ...
            add_action('admin_enqueue_scripts', [$this, 'quick_circle_menu_scripts'], 99);
