    ...
    class Module_Folders extends AdminSettingsModel
    {
        ...
        public function folders_user_roles(&$fields)
        {
            $fields[] = array(
                ...
                'content'   => Utils::adminfiy_help_urls(
                    __('Folders Settings', WP_ADMINIFY_TD),
            ...
            $fields[] = array(
                ...
                'type'       => 'checkbox',
                'title'      => __('Enable Folders for', WP_ADMINIFY_TD),
                'subtitle'   => __('Select Post Types for enabling Folders Module', WP_ADMINIFY_TD),
                'options'    => 'post_types',
                'query_args' => array(
                    'orderby' => 'post_title',
                    'order'   => 'ASC',
            ...
            if (!jltwp_adminify()->can_use_premium_code__premium_only()) {
                $fields[] = array(
                    ...
                    'dependency' => array(
                        array('folders_enable_for', 'not-any', 'post,page', 'true'),
                        array('folders_enable_for', '!=', '', 'true'),
                    ),
                );
            }
        }
        ...
        public function folders_for_media(&$fields)
        {
            $fields[] = array(
                'id'         => 'folders_media',
                'type'       => 'switcher',
                'title'      => __('Enable for Media', WP_ADMINIFY_TD),
