...
class Admin_Footer extends AdminSettingsModel
{
    ...
    public function admin_footer_settings()
    {
        ...
        \ADMINIFY::createSection(
            $this->prefix,
            array(
                'title'  => __('Admin Footer', WP_ADMINIFY_TD),
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'content'   => Utils::adminfiy_help_urls(
                            __('Admin Footer Settings', WP_ADMINIFY_TD),
                    ...
                    array(
                        ...
                        'type'       => 'switcher',
                        'title'      => __('Default WP Version', WP_ADMINIFY_TD),
                        'text_on'    => 'Show',
                        'text_off'   => 'Hide',
                        'text_width' => 90,
                    ...
                    array(
                        'type'    => 'subheading',
                        'content' => __('Adminify Footer', WP_ADMINIFY_TD),
                    ),

                    array(
                        'id'         => 'admin_footer_ip_address',
                        'type'       => 'switcher',
                        'title'      => __('IP Address', WP_ADMINIFY_TD),
                        'text_on'    => 'Show',
                        'text_off'   => 'Hide',
                        'text_width' => 90,
                    ...
                    array(
                        ...
                        'type'       => 'switcher',
                        'title'      => __('PHP Version', WP_ADMINIFY_TD),
                        'text_on'    => 'Show',
                        'text_off'   => 'Hide',
                        'text_width' => 90,
                    ...
                    array(
                        ...
                        'type'       => 'switcher',
                        'title'      => __('WordPress Version', WP_ADMINIFY_TD),
                        'text_on'    => 'Show',
                        'text_off'   => 'Hide',
                        'text_width' => 90,
                    ...
                    array(
                        ...
                        'type'       => 'switcher',
                        'title'      => __('Memory Usage', WP_ADMINIFY_TD),
                        'text_on'    => 'Show',
                        'text_off'   => 'Hide',
                        'text_width' => 90,
                    ...
                    array(
                        ...
                        'type'       => 'switcher',
                        'title'      => __('Memory Limit', WP_ADMINIFY_TD),
                        'text_on'    => 'Show',
                        'text_off'   => 'Hide',
                        'text_width' => 90,
                    ...
                    array(
                        ...
                        'type'       => 'switcher',
                        'title'      => __('Memory Available', WP_ADMINIFY_TD),
                        'text_on'    => 'Show',
                        'text_off'   => 'Hide',
                        'text_width' => 90,
                    ...
                    array(
                        'id'            => 'footer_text',
                        'type'          => 'wp_editor',
                        'title'         => __('Admin Footer Text', WP_ADMINIFY_TD),
                        'height'        => '100px',
                        'media_buttons' => false,
