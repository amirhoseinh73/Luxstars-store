    ...
    class Module_Google_PagesSpeed extends AdminSettingsModel
    {
        ...
        public function google_pagepseed_api_key(&$fields)
        {
            $fields[] = array(
                ...
                'content'   => Utils::adminfiy_help_urls(
                    __('Google Pagespeed Settings', WP_ADMINIFY_TD),
            ...
            $fields[] = array(
                ...
                'after'   => sprintf(__('Don\'t have API key? Create one from <a href="%1$s" target="_blank">Google Console</a> to Unlock this feature. Read the full <a href="%2$s" target="_blank">Documentation</a>', WP_ADMINIFY_TD), esc_url('https://console.developers.google.com'), esc_url('https://wpadminify.com/kb/how-to-create-google-api-key')),
        ...
        public function google_pagepseed_settings()
        {
            ...
            \ADMINIFY::createSection($this->prefix, array(
                'title'  => __('Google PageSpeed', WP_ADMINIFY_TD),
