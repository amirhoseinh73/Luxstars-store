    ...
    class Module_PostTypesOrder extends AdminSettingsModel
    {
        ...
        public function adminify_pto_taxonomy_notice(&$fields)
        {
            if (jltwp_adminify()->can_use_premium_code__premium_only()) {
                $fields[] =  array(
                    'id'         => 'pto_taxonomies',
                    'type'       => 'checkbox',
                    'title'      => __('Sortable Taxonomies', WP_ADMINIFY_TD),
        ...
        public function post_types_order_roles(&$fields)
        {
            ...
            $fields[] = array(
                'id'         => 'pto_posts',
                'type'       => 'checkbox',
                'title'      => __('Sortable Post Types', WP_ADMINIFY_TD),
                'subtitle'   => __('Select Post Types for sorting', WP_ADMINIFY_TD),
                'options'    => 'post_types',
                'query_args' => array(
                    'orderby' => 'post_title',
                    'order'   => 'ASC',
        ...
        public function post_types_order_media(&$fields)
        {
            $fields[] = array(
                'id'         => 'pto_media',
                'type'       => 'switcher',
                'title'      => __('Media Sortable', WP_ADMINIFY_TD),
                'text_on'    => 'Enabled',
                'text_off'   => 'Disabled',
                'text_width' => 100,
