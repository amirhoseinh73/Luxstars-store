...
class RollbackVersion
{
    ...
    { ?>
        ...
        <div class="border border-muted">
            ...
            <h3><?php echo __('Rollback Version', WP_ADMINIFY_TD); ?></h3>
            ...
            <p class="wp-adminify-roll-desc pt-2 has-text-danger">
                <?php echo __('Warning: Please backup your database before making the rollback.', WP_ADMINIFY_TD); ?>
            </p>
        </div>
            ...
            <div class="wp-adminify--popup-container has-text-centered">
                <div class="wp-adminify--popup-container_inner pt-6 pb-6">
                    <div class="wp-adminify-popup-header">
                        <?php echo __('Rollback to Previous Version', WP_ADMINIFY_TD); ?>
                    </div>
                    <div class="wp-adminify-dialog-message wp-adminify-dialog-confirm-message slow">
                        <?php echo __('Are you sure you want to reinstall previous version?', WP_ADMINIFY_TD); ?>
                    </div>
...
<?php }
    ...
    public function jltwp_adminify_rollback_fields(&$fields)
    {
        $fields[] = array(
            ...
            'content'   => Utils::adminfiy_help_urls(
                __('Rollback to Previous Version', WP_ADMINIFY_TD),
        ...
        $fields[] = array(
            'type'    => 'submessage',
            'style'   => 'info',
            'content' => sprintf(__('<strong>Experiencing an issue with %1$s <em>v%2$s</em>? Rollback to a previous version before the issue appeared.</strong>', WP_ADMINIFY_TD), WP_ADMINIFY, WP_ADMINIFY_VER),
        );
    ...
    public function jltwp_adminify_rollback_options()
    {
        ...
        \ADMINIFY::createSection($this->prefix, array(
            'title'  => __('Rollback Version', WP_ADMINIFY_TD),
