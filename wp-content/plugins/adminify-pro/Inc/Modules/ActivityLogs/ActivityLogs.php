...
class ActivityLogs
{
    ...
    public function jltwp_adminify_activity_logs_submenu()
    {
        $this->_screens['adminify_log'] = add_submenu_page(
            ...
            esc_html__('Activity Logs by WP Adminify', WP_ADMINIFY_TD),
            esc_html__('Activity Logs', WP_ADMINIFY_TD),
    ...
    public function init_actions()
    {
        ...
        if ($action == 'delete') {
            ...
            $adminify_activity_logs = new \WPAdminify\Inc\Modules\ActivityLogs\ActivityLogs();
...
?>
        <div class="wrap">
            <h1 class="wp-adminify-page-title"><?php _ex('Activity Log', 'Page and Menu Title', WP_ADMINIFY_TD); ?></h1>
