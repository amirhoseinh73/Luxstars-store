...
class Style extends Notification_Customize
{
    ...
    public function get_style_fields(&$style_fields)
    {
        ...
        //     'id'      => 'presets',
        //     'type'    => 'palette',
        //     'title'   => __('Presets', WP_ADMINIFY_TD),
        //     'options' => array(
        ...
        $style_fields[] = array(
            'id'      => 'btn_color',
            'type'    => 'color',
            'title'   => __('Close Button Background', WP_ADMINIFY_TD),
            'class'   => 'wp-adminify-cs',
        ...
        $style_fields[] = array(
            'id'      => 'btn_text_color',
            'type'    => 'color',
            'title'   => __('Close Btn Text Color', WP_ADMINIFY_TD),
            'class'   => 'wp-adminify-cs',
        ...
        $style_fields[] = array(
            'id'      => 'link_bg_color',
            'type'    => 'color',
            'title'   => __('Learn More BG Color', WP_ADMINIFY_TD),
            'class'   => 'wp-adminify-cs',
        ...
        $style_fields[] = array(
            'id'      => 'link_color',
            'type'    => 'color',
            'title'   => __('Learn More Color', WP_ADMINIFY_TD),
            'class'   => 'wp-adminify-cs',
            'default' => $this->get_default_field('link_color'),
        );
    }
    ...
    public function style_notif_bar_customizer()
    {
        ...
        \ADMINIFY::createSection(
            ...
            array(
                ...
                'title'  => __('Style Settings', WP_ADMINIFY_TD),
                'fields' => $style_fields
            )
        );
    }
