...
if (!class_exists('NotificationBar')) {
    class NotificationBar
    {
        ...
        {
            wp_enqueue_script('adminify-notification-bar-customizer', $this->url . '/assets/js/notification-bar-customizer.js', array('jquery', 'customize-controls'), WP_ADMINIFY_VER, true);
        ...
        public function notification_bar_preview_script()
        {
            ...
            wp_enqueue_script('adminify-notification-bar-preview', $this->url . '/assets/js/notification-bar-preview.js', array('jquery', 'customize-preview'), WP_ADMINIFY_VER, true);
        ...
        public function notification_bar_submenu()
        {
            add_submenu_page(
                ...
                esc_html__('Notification Bar by WP Adminify', WP_ADMINIFY_TD),
                esc_html__('Notification Bar', WP_ADMINIFY_TD),
        ...
        public function notification_bar_register_panels($wp_customize)
        {
            $wp_customize->add_panel(
                ...
                array(
                    'title'             => __('Notification Bar - WP Adminify', WP_ADMINIFY_TD),
                    'description'       => __('Customize Notification Bar with WP Adminify :)', WP_ADMINIFY_TD),
