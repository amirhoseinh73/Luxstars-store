...
class PostDuplicator
{
    ...
    public function jltma_duplicator_row_actions($actions, $post)
    {
        if (current_user_can('edit_posts')) {
            ...
            $actions['adminify_duplicate'] = sprintf('<a href="%s" title="%s" rel="permalink">%s</a>', $adminify_duplicate_link,  __('Duplicate this item ' . $post->post_title, WP_ADMINIFY_TD), esc_html__('Adminify Clone', WP_ADMINIFY_TD));
        }
        return $actions;
    }
