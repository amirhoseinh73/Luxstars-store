...
<div class="wp-adminify-badge <?php echo esc_attr($position_class) . ' ' . esc_attr($visibility); ?>">
    <div class="wp-adminify-badge__inner">
        <span class="wp-adminify-badge__text"><?php _e('Powered by', WP_ADMINIFY_TD); ?></span>
        ...
        <a class="wp-adminify-badge__link" href="https://wordpress.org/plugins/adminify/" alt="<?php echo __('Get WP Adminify today', WP_ADMINIFY_TD); ?>" target="_blank"></a>
