...
class Button_Section extends Customize_Model
{
    ...
    public function button_fields_normal_settings(&$button_fields_normal)
    {
        ...
        $button_fields_normal[] = array(
            'type'    => 'subheading',
            'content' => __('Text Shadow', WP_ADMINIFY_TD),
        );
    ...
    public function button_fields_advance_settings(&$button_fields_advance)
    {
        ...
        $button_fields_advance[] = array(
            'type'    => 'subheading',
            'content' => __('Border', WP_ADMINIFY_TD),
        );
    ...
    public function advance_box_shadow(&$advance_box_shadow)
    {
        ...
        if (jltwp_adminify()->can_use_premium_code__premium_only()) {
            $advance_box_shadow[] = array(
                ...
                'options' => array(
                    ''        => __('Outline', WP_ADMINIFY_TD),
                    'inset'   => __('Inset', WP_ADMINIFY_TD),
                ),
    ...
    public function button_customizer_settings(&$button_customizer_settings)
    {
        ...
        $button_customizer_settings[] = array(
            'type'    => 'subheading',
            'content' => __('General Settings', WP_ADMINIFY_TD),
        );
        ...
        if (jltwp_adminify()->can_use_premium_code__premium_only()) {
            $button_customizer_settings[] = array(
                'id'      => 'button_size',
                'type'    => 'dimensions',
                'title'   => __('Button Width & Height', WP_ADMINIFY_TD),
        ...
        $button_customizer_settings[] = array(
            ...
            'type'  => 'slider',
            'unit'  => 'px',
            'title' => __('Font Size', WP_ADMINIFY_TD),
        ...
        $button_customizer_settings[] = array(
            ...
            'type'  => 'tabbed',
            'title' => __('Button', WP_ADMINIFY_TD),
            'tabs'  => array(

                array(
                    'title'  => __('Normal', WP_ADMINIFY_TD),
                    'fields' => $button_fields_normal
                ),

                array(
                    'title'  => __('Hover', WP_ADMINIFY_TD),
                    'fields' => $button_fields_hover
                ),

                array(
                    'title'  => __('Advanced', WP_ADMINIFY_TD),
