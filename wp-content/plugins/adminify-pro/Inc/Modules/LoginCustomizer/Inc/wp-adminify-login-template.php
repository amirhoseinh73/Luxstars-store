...
?>
	...
	<body class="login wp-adminify <?php echo esc_attr(implode(' ', $classes)); ?>">
		...
		<div class="columns all-centered">
			<div id="login">
				<h1>
					<a class="wp-adminify-logo-login-link" id="wp-adminify-logo-login-link" href="https://litoanoare.com<?php //echo esc_url($login_header_url);
																														?>" title="<?php echo esc_attr($login_header_text); ?>">
	...
	?>
		...
		<p id="nav">
			...
			<a href="<?php echo esc_url(wp_lostpassword_url()); ?>">
				<span id="wp-adminify-lost-password">
	...
	?>
		...
		<form name="loginform" class="show-only_login" id="loginform" action="<?php echo esc_url(site_url('wp-login.php', 'login_post')); ?>" method="post">
			<p>
				...
				<input type="text" name="log" id="user_login" <?php echo $aria_describedby_error; ?> class="input" placeholder="Username/Email" value="<?php echo esc_attr($user_login); ?>" size="20" autocapitalize="off" />
			</p>
			...
			<div class="user-pass-wrap">
				...
				<div class="wp-pwd">
					<input type="password" name="pwd" id="user_pass" <?php echo $aria_describedby_error; ?> class="input password-input" value="" placeholder="Password" size="20" />
