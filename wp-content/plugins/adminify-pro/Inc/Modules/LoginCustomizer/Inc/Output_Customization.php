    ...
    class Output_Customization
    {
        ...
        public function jltwp_adminify_login_body_class($classes)
        {
            ...
            if (isset($this->options['logo_settings']) && 'text-only' == $this->options['logo_settings']) {
                $classes[] = 'wp-adminify-both-logo';
            }

            if (isset($this->options['logo_settings']) && 'both' == $this->options['logo_settings']) {
                $classes[] = 'wp-adminify-both-logo wp-adminify-text-logo';
            }

            if (isset($this->options['logo_settings']) && 'show-text-only' == $this->options['logo_settings']) {
                $classes[] = 'wp-adminify-text-logo';
            }

            if (isset($this->options['logo_settings']) && 'use-both' == $this->options['logo_settings']) {
                $classes[] = 'wp-adminify-text-logo wp-adminify-both-logo';
            }


            // Column Widths
            if ('fullwidth' == !empty($this->options['alignment_login_width'])) {
                if (!empty($this->options['alignment_login_bg_skew']) != 0) {
                    $classes[] = 'wp-adminify-fullwidth';
                }
            }
            if ('width_two_column' == !empty($this->options['alignment_login_width'])) {
            ...
            // Templates Class
            if ($this->options['templates'] == 'template-05' || $this->options['templates'] == 'template-11' || $this->options['templates'] == 'template-12' || $this->options['templates'] == 'template-13') {
                $classes[] = 'wp-adminify-half-screen';
                $classes[] = 'jltwp-adminify-login-right';
            }
        ...
        {
            $logo_link = (isset($this->options['logo_login_url']['url']) && !empty($this->options['logo_login_url']['url'])) ? $this->options['logo_login_url']['url'] : "https://wordpress.org/";
            // $logo_text = !empty($this->options['logo_login_url']['text']);
            // $logo_target = !empty($this->options['logo_login_url']['target']);
            $logo_url = str_ireplace('{home_url}', home_url(), $logo_link);
            return $logo_url;
        }
        ...
        */
        public function print_login_styles()
        {
            ...
            echo '<style class="wp-adminify-login-customizer-style">';
            ob_start();
            require dirname(__FILE__) . '/login-styles.php';
            $css = ob_get_clean();

            echo apply_filters('wp_adminify_login_styles', $css);
            echo '</style>';
        ...
        {
            if (!empty($this->options['jltwp_adminify_login_bg_type']) === "video") {
                $video_html = '';
        ...
        {
            $templates = !empty($this->options['templates']) ? $this->options['templates'] : 'template-01';
            if ($templates === 'template-05' || $templates === 'template-11' || $templates === 'template-12' || $templates === 'template-13') {
                echo '<div class="wp-adminify-container"><div class="wp-adminify-extra-div"></div><div class="wp-adminify-form-container">';
            } else {
        ...
        public function change_register_username_label($translated_text, $text, $domain)
        {
            ...
            // $label   = 'This is Changed Label Register Username';
        ...
        public function change_register_email_label($translated_text, $text, $domain)
        {
            ...
            // $label   = 'This is Changed Label Register Email';
        ...
        public function change_register_register_label($translated_text, $text, $domain)
        {
            ...
            // $label   = 'This is Changed Label Register Button';
        ...
        public function change_register_confirmation_text($translated_text, $text, $domain)
        {
            ...
            $label   = 'This is Changed Label Conf Email';
        ...
        public function change_login_register_link_text($translated_text, $text, $domain)
        {
            ...
            $label   = 'This is Changed Login Link Label';
        ...
        {
            $default = __('Log In', WP_ADMINIFY_TD);
        ...
        {
            $default = __('Register', WP_ADMINIFY_TD);
        ...
        {
            $default = 'Username or Email Address';
            $label   = $this->options['login_form_fields']['label_lost_password'];
        ...
        public function change_lostpasswords_button_label($translated_text, $text, $domain)
        {
            ...
            $label   = 'This is Changed Label Get New Pass';
