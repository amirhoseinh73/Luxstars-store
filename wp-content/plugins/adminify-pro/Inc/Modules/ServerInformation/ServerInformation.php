...
class ServerInformation
{
    ...
    public function adminify_error_logs_object()
    {
        return array(
            ...
            'label_update'   => esc_html__('Will be updated...', WP_ADMINIFY_TD),
            'label_clear'    => esc_html__('Will be cleared...', WP_ADMINIFY_TD),
            'label_done'     => esc_html__('Done!', WP_ADMINIFY_TD)
        );
    }
...
<?php }
        ...
        if ($mysqlinfo) {
            ...
            echo '<thead><tr><th>' . __('Variable Name', WP_ADMINIFY_TD) . '</th><th>' . __('Value', WP_ADMINIFY_TD) . '</th></tr></thead><tbody>' . "\n";
