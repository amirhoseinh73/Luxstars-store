...
?>
    ...
    <div class="wrap">
        ...
        <h1>
            <?php echo Utils::admin_page_title(esc_html__('Robots.txt File', WP_ADMINIFY_TD)); ?>
        </h1>
        ...
        <p>
            <strong><?php esc_html_e('To affect your custom configuration in the robots.txt file, you have to save the file in the "root" folder of your WordPress installation.', WP_ADMINIFY_TD); ?></strong>
        </p>
        ...
        <p>
            ...
            <br>
            <a href="https://wordpress.org/support/article/search-engine-optimization/#robots-txt-optimization" target="_blank" rel="noopener"><?php esc_html_e('Learn more about the robots.txt file in WordPress.', WP_ADMINIFY_TD); ?></a>
        </p>
    </div>
        ...
        if ($file) { ?>
            <p>
                <?php echo esc_html__('robots.txt file was found at:', WP_ADMINIFY_TD) . ' <strong>' . esc_html($file) . '</strong>'; ?>
                <br>
            </p>
        <?php } ?>
