...
?>
        <div class="wrap">
            <h1>
                <?php echo Utils::admin_page_title(esc_html__('.htaccess file', WP_ADMINIFY_TD)); ?>
            </h1>
        </div>
        ...
        <p>
            <?php esc_html_e('The .htaccess is a distributed configuration file, and is how Apache server handles configuration changes on a per-directory basis.', WP_ADMINIFY_TD); ?>
            <br>
            <a href="https://wordpress.org/support/article/htaccess/" target="_blank" rel="noopener"><?php esc_html_e('Learn more about the .htaccess file in WordPress.', WP_ADMINIFY_TD); ?></a>
        </p>
        ...
        if ($file) { ?>
            <p>
                <?php echo esc_html__('.htaccess file was found at:', WP_ADMINIFY_TD) . ' <strong>' . esc_html($file) . '</strong>'; ?>
                <br>
            </p>
        <?php } ?>
