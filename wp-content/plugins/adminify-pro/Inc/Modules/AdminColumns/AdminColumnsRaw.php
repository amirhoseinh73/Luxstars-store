...
class AdminColumnsRaw
{
    ...
    public function jltwp_adminify_admin_columns_menu()
    {
        add_submenu_page(
            ...
            esc_html__('Admin Columns by WP Adminify', WP_ADMINIFY_TD),
            esc_html__('Admin Columns', WP_ADMINIFY_TD),
                            ...
                            <ul>
                                <li>
                                    <a href="#post-types">
                                        ...
                                        <span> <?php _e('Post Types', WP_ADMINIFY_TD); ?> </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#taxonomies">
                                        ...
                                        <span> <?php _e('Taxonomies', WP_ADMINIFY_TD); ?> </span>
                                    </a>
                                </li>
                            </ul>
                        </div>
