...
class Adminify_RecentPosts
{
    ...
    public function jltwp_adminify_recent_posts_widget_register()
    {
        wp_add_dashboard_widget(
            ...
            esc_html__('Recent Posts - Adminify', WP_ADMINIFY_TD),
            ...
            if ($adminify_dash_recent_posts->have_posts()) { ?>
                ...
                <div class="wp-adminify-recent-posts">
                    <table class="adminify-recent-posts-table">
                        <tr>
                            <th><?php echo esc_html__('Post Title', WP_ADMINIFY_TD); ?></th>
                            <th><?php echo esc_html__('Author', WP_ADMINIFY_TD); ?></th>
                            <th><?php echo esc_html__('Category', WP_ADMINIFY_TD); ?></th>
                            <th>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $categories_list = get_the_category_list(__(', ', WP_ADMINIFY_TD));
                                    if ($categories_list) {
                                        printf(
                                            /* translators: %s: List of categories. */
                                            '<div class="adminify-post-category">' . esc_html__('%s', WP_ADMINIFY_TD) . ' </div>',
                                ...
                                <td>
                                    <div class="adminify-post-comments">
                                        <span class="adminify-post-counter">
                                            <?php comments_number(esc_html__('0', WP_ADMINIFY_TD), esc_html__('1', WP_ADMINIFY_TD), esc_html__('%', WP_ADMINIFY_TD)); ?>
                                        </span>
                                    </div>
                                </td>
                            </tr>
