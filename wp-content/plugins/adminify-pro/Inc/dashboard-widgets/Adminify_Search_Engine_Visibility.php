...
class Adminify_Search_Engine_Visibility
{
    ...
    public function jltwp_adminify_search_engine_visibility()
    {
        wp_add_dashboard_widget(
            ...
            esc_html__('Search Engine Visibility - Adminify', WP_ADMINIFY_TD),
...
?>
            <div class="wp-adminify-seo-visibility">
                <div class="wp-adminify-seo-visibility-focus adminify-warning">
                    ...
                    <div><?php esc_html_e('Your website is currently not visible to search engines!', WP_ADMINIFY_TD); ?></div>
                </div>
            </div>
        <?php
        } else {
        ?>
            <div class="wp-adminify-seo-visibility">
                <div class="wp-adminify-seo-visibility-focus adminify-success">
                    ...
                    <div><?php esc_html_e('Your website is currently visible to search engines', WP_ADMINIFY_TD); ?></div>
                </div>
            </div>
<?php
        }
