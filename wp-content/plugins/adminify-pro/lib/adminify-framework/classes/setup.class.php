...
if ( ! class_exists( 'ADMINIFY' ) ) {
  class ADMINIFY {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      if ( $wpscreen->is_network && strpos($wpscreen->id, 'wp-adminify_page_adminify') !== false ) {
        self::$enqueue = true;
      }
      ...
      if ( apply_filters( 'adminify_fa4', false ) ) {
        ...
        wp_enqueue_style( 'adminify-fa5', 'https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.3/css/all'. $min .'.css', array(), '5.15.3', 'all' );
        wp_enqueue_style( 'adminify-fa5-v4-shims', 'https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.3/css/v4-shims'. $min .'.css', array(), '5.15.3', 'all' );
      }
