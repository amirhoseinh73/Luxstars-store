<style media="screen" class="wp-adminify-style-wp">
    ...
    body.wp-adminify-login-customizer.login .wp-adminify-extra-div {
        background: url('https://wpadminify.com/wp-content/uploads/2021/06/login-bg-13.jpg');
    ...
    body.wp-adminify-login-customizer.login .wp-adminify-extra-div:before {
        content: '';
        background: rgba(78, 75, 102, 0.7);
        height: 100%;
        width: 100%;
        left: 0;
        top: 0;
    ...
    body.wp-adminify-half-screen .wp-adminify-form-container {
        height: 100%;
        position: relative;
    }
