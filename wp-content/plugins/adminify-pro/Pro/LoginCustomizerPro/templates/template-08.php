<style media="screen" class="wp-adminify-style-wp">
    body.wp-adminify-login-customizer {
        background: url('https://wpadminify.com/wp-content/uploads/2021/06/login-bg-08.jpg') no-repeat;
        background-size: cover;
    }

    body.wp-adminify-login-customizer .wp-adminify-container {
        background: rgba(42, 41, 53, .7);
        height: 100%;
    }

    body.wp-adminify-login-customizer #login a.wp-adminify-logo-login-link {
