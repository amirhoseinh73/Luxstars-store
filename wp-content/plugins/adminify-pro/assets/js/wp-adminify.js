...
(function ($)
{
    ...
    $(window).load(function ()
    {
        ...
        setTimeout(function () { $('.wp-adminify.adminify-top_bar').show(); }, 200);
    ...
    var WP_Adminify = {
        ...
        Dismiss_Notice: function(){
			$( 'div[data-dismissible] .notice-dismiss,div[data-dismissible] .adminify-notice-dismiss, div[data-dismissible] .dismiss-this' ).click(
				function (event) {
    ...
    $(document).ready(function ()
    {
        ...
        $('.adminify-copy-btn').click(function (e)
        {
            e.preventDefault();
            $('.adminify-copy-btn').copyToClipboard({
                parent: '.adminify-server-info',
