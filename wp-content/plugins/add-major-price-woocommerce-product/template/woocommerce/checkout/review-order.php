...
<table class="shop_table woocommerce-checkout-review-order-table">
				...
				<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<td class="product-total">
						<?php if( user_is_wholesaler() ) : ?>
							<?php
							$payment_method_wholesaler = $_SESSION[ "pay_way" ];
							$price_with_quantity = intval( $_product->get_meta( "_major_price_$payment_method_wholesaler" ) ) * intval( $cart_item['quantity'] );
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			...
			<?php if ( user_is_wholesaler() ) :?>
				<td>
					<?= separate_price_number_with_comma( calc_wholesaler_total_cart( $payment_method_wholesaler ) ); ?>
					تومان
				</td>
			<?php else : ?>
