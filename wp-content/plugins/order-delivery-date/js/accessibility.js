jQuery(function (jQuery) {
    jQuery('#' + orddd_access.orddd_field_name ).datepicker({
      onClose: removeAria
    });
  
    // Add aria-describedby to the button referring to the label
    jQuery( '#' + orddd_access.orddd_field_name ).attr('aria-describedby', 'Delivery Date');
  ...
  function dayTripper() {
    jQuery('#' + orddd_access.orddd_field_name ).focus(function () {
      setTimeout(function () {
  ...
  function appendOffscreenMonthText(button) {
    ...
    var numberOfMonths = orddd_access.orddd_number_of_months;
