...
<style>
    ...
    .background {
        ...
        width: 100%;
        height: 100vh;
        background: linear-gradient(#a5a5a5, #32323294);
        z-index: -1;
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="amh_nj-breadcrumb">
                                ...
                                <a class="amh_nj-breadcrumb-text font-12">404</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 col-sm-6 mx-auto">
            <div class="left-section">
                <div class="inner-content">
                    ...
                    <p class="subheading text-boot fw700 text-center font-20 LH-3">به نظر میرسد اشتباهی پیش آمده، لطفا دوباره به خانه برگردید و صفحه مورد نظرتان جستجو کنید.</p>

                    <div class="row py-3">
                        <div class="col-5 mx-auto">
                            <a href="<?php echo home_url();?>" class="btn btn-outline-light text-boot-sec btn-block">صفحه اصلی</a>
                        </div>
                        <div class="col-5 mx-auto">
                            <a href="<?php echo home_url();?>/contact-us/" class="btn btn-light text-boot-grad btn-block">تماس با ما</a>
                        </div>
                    </div>
                </div>
            </div>
