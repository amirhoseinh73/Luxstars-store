        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 text-md-right text-center my-auto">
                    <label class="font-11 text-light">
                        <i class="far fa-copyright pl-1 align-middle text-white"></i>
                        1399-<?= wp_date('Y')?>
                ...
                <div class="col-12 col-md-6 text-md-left text-center my-auto o-25">
                    <label class="font-11 text-light" style="direction:ltr;font-family: arial,sans-serif">
                        <i class="far fa-copyright pl-1 align-middle text-white"></i>
                        1401 Designed By
                        <a class="text-boot-2" target="_blank" href="https://www.instagram.com/amirhoseinh73/">
                            Amirhosein Hasani
                        </a>
                    </label>
                </div>
